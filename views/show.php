...
<body>
    ...
    <div id="modalDificultad" class="modal-fin" style="display:flex;">
        <div class="modal-fin-content">
            <h2>Selecciona dificultad</h2>

            <button class="btn-modal dificultad-btn" data-id="1">Easy</button>
            <button class="btn-modal dificultad-btn" data-id="2">Normal</button>
            <button class="btn-modal dificultad-btn" data-id="3">Hard</button>
        </div>
    </div>
